...
- `StateVector` (signals/types.ts): 12-dimensional feature vector for AI
...
- Risk: 50% stop loss, TP at 2x/3x, 20% trailing stop
- Filters: minRugScore=45, minLiquiditySol=1, minPumpHeat=33
- DDQN: 12 state dims, 3 actions, epsilon-greedy exploration
